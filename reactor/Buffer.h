...
namespace wnet::net {
    ...
    public:
        ...
        void append(const char *data, size_t len) {//把[data, data+len]内存上的数据添加到writable缓冲区当中
    ...
    private:
        ...
        void makeSpace(size_t len) {
            if (writableBytes() + prependableBytes() - kCheapPrepend < len) {//能用来写的缓冲区大小 < 我要写入的大小len，那么就要扩容了
